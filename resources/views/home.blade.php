                        ...
                        <ul class="list-group">
                            @foreach ($addresses as $address)
                                <li class="list-group-item">
                                    ...
                                    <a href="{{ route('addresses.edit', $address->id) }}" class="btn btn-secondary btn-sm mt-2">Editar</a>
                                </li>
                            @endforeach
                        </ul>
                        <a href="{{ route('addresses.create') }}" class="btn btn-primary mt-3">Añadir nueva dirección</a>
                    @endif
                </div>
            </div>
        </div>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    @if ($sales->isEmpty())
                        ...
                        <a href="{{ route('sales.index') }}" class="btn btn-primary">Ver productos</a>
                    @else
                        <ul class="list-group">
                            @foreach ($sales as $sale)
                                <li class="list-group-item">
                                    ...
                                    <a href="{{ route('sales.show', $sale->id) }}" class="btn btn-secondary btn-sm mt-2">Ver Detalles</a>
                                </li>
                            @endforeach
                        </ul>
                        <a href="{{ route('sales.index') }}" class="btn btn-primary mt-3">Ver todos los pedidos</a>
                    @endif
                </div>
            </div>
        </div>
